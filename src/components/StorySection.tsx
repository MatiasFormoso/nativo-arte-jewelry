      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="aspect-square relative overflow-hidden shadow-xl group">
            ...
            <div className="absolute inset-0 border-2 border-[#8B7355]/40 rounded-sm" style={{
              boxShadow: 'inset 0 0 0 1px rgba(255,255,255,0.3), 0 4px 20px rgba(139,115,85,0.15)'
            }}></div>
            
            {/* Borde interno sutil */}
            <div className="absolute inset-[2px] border border-[#8B7355]/20 rounded-sm pointer-events-none" style={{
